...
#endif
{
	...
	namespace Internal
	{
		...
		partial class LibZEntry
		{
			...
			/// <summary>SHA-1-based hash.</summary>
			/// <value>The SHA-1-based hash.</value>
		...
		/// <summary>SHA-1 hash calculator.</summary>
		internal class Hash
		{
			#region public interface

			/// <summary>Computes the Guid using SHA-1 for specified byte array.</summary>
			...
			/// <summary>Computes the Guid for the specified text (case insensitive).</summary>
